/* ===========================================================================
   ...
   =========================================================================== */
import { IMG, IMG_SRCSET, CREDITS } from '../../data/images.js';
...
var DS = (function () {
  ...
  function photo(key, alt) {
    if (!IMG[key]) return '';
    var set = IMG_SRCSET[key];
    return '<img src="' + IMG[key] + '"' + (set ? ' srcset="' + set + '" sizes="(min-width: 960px) 50vw, 100vw"' : '') + ' alt="' + esc(alt) + '" decoding="async">' +
